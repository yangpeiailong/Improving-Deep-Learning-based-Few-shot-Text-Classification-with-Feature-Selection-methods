...
def train():
    ...
    for m, batch in enumerate(dataset_train):
        ...
        # print(pred.shape, batch[3].shape)
...
if __name__ == '__main__':
    ...
    sample_data_file = 'e:/pythonwork/newclassification/dataset_after_feature_selection/' + dataname + '_' + num_of_sample + '.txt'
    label_data_file = 'e:/pythonwork/newclassification/dataset_after_feature_selection/' + dataname + '_' + num_of_sample + '_label.txt'
    # sample_data_file = 'e:/pythonwork/newclassification/dataset_after_feature_selection/' + dataname + '.txt'
    # label_data_file = 'e:/pythonwork/newclassification/dataset_after_feature_selection/' + dataname + '_label.txt'
    ...
    maxlen = max([len(sample) for sample in samples])
    print('maxlen:', maxlen)
    ...
    with open('model/label_to_index_bert_for_' + dataname + '_' + num_of_sample + '.txt', 'w', encoding='utf-8') as f:
        ...
        f.close()
    # with open('model/label_to_index_bert_for_' + dataname  + '.txt', 'w', encoding='utf-8') as f:
    #     for i in label2ind.keys():
    #         f.writelines(str(i) + ':' + str(label2ind[i]) + '\n')
    #     f.close()
    ...
    for i in range(k):
        ...
        for j in range(len(classifier_list)):
            ...
            if classifier_list[j] == 'basebert':
                ...
                optimizer = optim.SGD(bc.parameters(), lr=1e-5, weight_decay=1e-2)
            ...
            #     'model/model_params_best_{data}_{modelname}_{k_num}.pkl'.format(data=dataname, modelname=classifier_list[
            #                                                                                     j], k_num=i)))
    ...
    # book.save(
    #     'e:/pythonwork/newclassification/results/' + dataname + '_bert_criteria.xls')
    book.save(
        'e:/pythonwork/newclassification/results_with_feature_selection/' + dataname + '_' + num_of_sample + '_bert_criteria.xls')
    # book.save(
    #     'e:/pythonwork/newclassification/results_with_feature_selection/' + dataname + '_bert_criteria.xls')
